		...
		<tr>
			<td width="1007" bgcolor="#FFFFFF">
				<p>
					...
					เหมาะสำหรับ <br> นักศึกษา ใกล้แหล่งชุมชน และ ห้างสรรพสินค้า BigC , Lotus , Central 
				<p>
					ห้องพักทันสมัย เฟอร์นิเจอร์อย่างดี และสุขภัณฑ์ครบครัน 
					อาทิ WIFI อินเทอร์เน็ตความเร็วสูงทุกห้อง มีพัดลม และเครื่องปรับอากาศให้เลือก มีทีวี
					คอมพิวเตอร์ให้เช่า
				<p>
					เชิญชมห้องตัวอย่าง ได้ทุกวันนนนนนน <a href=amit.php>ติดต่อสอบถาม</a>	
			</td>
